...
function CookieReducer(state, action) {
  switch (action.type) {
    ...
    case "-5":
      return state - 5;
    default:
      throw new Error(`I don't know what you're trying to do! dispatch something else.`);
  }
}

export default function CookieProvider({ children }) {
  // as an argument, useReducer takes a reducer function, initial state)
...
export function useCookie() {
  // give values
  // tell it what context we're trying to retrieve
